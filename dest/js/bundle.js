...
},{"./jquery":2,"./utils":3}],2:[function(require,module,exports){
...
(function (window, undefined) {
	...
	jQuery.extend({
		...
		type: function type(obj) {
			...
			class2type[core_toString.call(obj)] || "object" : typeof
		...
		add: function add(elem, types, handler, data, selector) {
			...
			if (!(eventHandle = elemData.handle)) {
				eventHandle = elemData.handle = function (e) {
					...
					return (typeof jQuery === "undefined" ? "undefined" : _typeof(jQuery)) !== core_strundefined && (!e || jQuery.event.triggered !== e.type) ?
		...
		if (s.crossDomain) {
			...
			return {
				send: function send(_, complete) {
					...
					on(
					"load error",
					_callback = function callback(evt) {
						script.remove();
						_callback = null;
						if (evt) {
